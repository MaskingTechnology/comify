...
export default async function (requester: Requester, followerId: Identifier, range: Range): Promise<Relation[]>
{
    validateRange(range);

    const records = await retrieveByFollower(followerId, range.limit, range.offset);
