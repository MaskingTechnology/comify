...
describe('domain/notification/create', () =>
{
    ...
    {
        await create(VALUES.IDS.CREATOR1, Types.RATED_POST, VALUES.IDS.CREATOR2, VALUES.IDS.POST_RATED);
    ...
    {
        await create(VALUES.IDS.CREATOR2, Types.RATED_REACTION, VALUES.IDS.CREATOR1, undefined, VALUES.IDS.REACTION_LIKED);
    ...
    {
        await create(VALUES.IDS.CREATOR1, Types.STARTED_FOLLOWING, VALUES.IDS.CREATOR2);
    ...
    {
        await create(VALUES.IDS.CREATOR1, Types.ADDED_REACTION, VALUES.IDS.CREATOR2);
