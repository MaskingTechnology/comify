...
const creator0: RecordData = { fullName: 'John Doe', nickname: 'Doedel', email: 'john.doe@mail.com', portraitId: undefined, joinedAt: new Date(), popularity: 0 };
const creator1: RecordData = { fullName: 'Peter Pan', nickname: 'Panic', email: 'peterpan@mail.com', portraitId: undefined, joinedAt: new Date(), popularity: 0 };
const creator2: RecordData = { fullName: 'Bas Bax', nickname: 'Baxel', email: 'basbax@mail.com', portraitId: undefined, joinedAt: new Date(2024, 1, 24), popularity: 0 };
const creator3: RecordData = { fullName: 'Batsie Baby', nickname: 'BabyBas', email: 'creator3@mail.com', portraitId: undefined, joinedAt: new Date(2024, 2, 12), popularity: 2 };
const creator4: RecordData = { fullName: 'Paul Pal', nickname: 'Pickle', email: 'creator4@mail.com', portraitId: undefined, joinedAt: new Date(2024, 4, 9), popularity: 1 };
const creator5: RecordData = { fullName: 'Blank Bastard', nickname: 'Picture', email: 'creator5@mail.com', portraitId: undefined, joinedAt: new Date(2024, 3, 18), popularity: 3 };
