...
export const CREATOR_RECORDS: Record<string, CreatorRecord> = {
    ...
    EVE: { id: 'e4436c29-ef16-40f9-a3af-7b26725d2256', fullName: 'Eve Edwards', nickname: 'theartist', email: 'eve@example.com', tenantId: TENANTS.EFGH.id, joinedAt: new Date(2024, 4, 15).toISOString() },
    FELIX: { id: '1956b2f9-7797-4453-b5e9-1e679f97371d', fullName: 'Felix Fischer', nickname: 'creative', email: 'felix@example.com', tenantId: TENANTS.EFGH.id, joinedAt: new Date(2024, 5, 8).toISOString() },
    GEORGE: { id: '0cb5c89b-3c29-49e9-b7e8-a31b2ff2746c', fullName: 'George Gomez', nickname: 'creative_001', email: 'george@example.com', tenantId: TENANTS.EFGH.id, joinedAt: new Date(2024, 5, 10).toISOString() },
    HENRY: { id: 'b0c5d0ba-a360-4da3-bf46-f459ae528251', fullName: 'Henry Higgins', nickname: 'creative_999', email: 'henry@example.com', tenantId: TENANTS.EFGH.id, joinedAt: new Date(2024, 7, 11).toISOString() },
} as const;
