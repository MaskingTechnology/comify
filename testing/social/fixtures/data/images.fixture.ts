...
export const IMAGE_URLS: Record<string, URL> = {
    PROFILE: new URL('https://example.com/profile.png')
} as const;
...
export type IMAGE_URLS = typeof IMAGE_URLS[keyof typeof IMAGE_URLS];
